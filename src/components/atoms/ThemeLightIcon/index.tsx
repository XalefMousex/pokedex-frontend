import { type ThemeLightIconProps } from './types';

export const ThemeLightIcon = ({ ...props }: ThemeLightIconProps) => (
  <svg
  ...
  >
    ...
    />
    <circle cx={6.7} r={3.54} cy={7.04} fill="#fff" />
    <path
      fill="#fff"
    ...
    <circle r={8} cx={62.74} cy={16.32} fill="#fff" />
    <g fill="#d9d9d9">
